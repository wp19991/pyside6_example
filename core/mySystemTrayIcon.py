...
from PySide6.QtWidgets import QSystemTrayIcon, QApplication, QMenu, QGraphicsDropShadowEffect, QStyle
...
class MySystemTrayIcon(QSystemTrayIcon):
    ...
    def setupUi(self):
        ...
        self.icon.addPixmap(QtGui.QPixmap(":/icon/icon/app.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
